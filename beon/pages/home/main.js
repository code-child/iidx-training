  ...
  return (
    <>
                ...
                <main className="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div className="sm:text-center lg:text-left">
                        ...
                        <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                            As a wonderful opportunity to further grow and expand the BEMANI community in our local region,  a sub community was created under the umbrella of BEMANI Indonesia, beginning with our location at ÆON Mall BSD City.
                        </p>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <img className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="/img/beon.png" alt="BEON Community" />
        </div>
    </>
  );
}
